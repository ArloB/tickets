...
func (s *Server) routeTable() []routeEntry {
	return []routeEntry{
		...
		{http.MethodPost, "/api/v1/plans/{ref}/status", routeEditor, s.updateContentItemStatus(domain.KindPlan)},
		...
		{http.MethodPost, "/api/v1/documents/{ref}/status", routeEditor, s.updateContentItemStatus(domain.KindDocument)},
